...
namespace DataJuggler.NET8
{
	...
	public class SQLGenerator
	{
		...
		#region Methods
			...
			#region BuildFieldClause(DataJuggler.NET8.DataField field)
			public string BuildFieldClause(DataJuggler.NET8.DataRow FieldRow, DataJuggler.NET8.DataField Field, int FieldCount)
			{
				// if FieldCount > 0
			...
			#region BuildWhereClause(DataJuggler.NET8.DataRow row)
			public string BuildWhereClause(DataJuggler.NET8.DataRow Row)
			{
				...
				foreach(DataJuggler.NET8.DataField Field in Row.Fields)
				{
			...
			#region CreateDeleteSQL(DataJuggler.NET8.DataRow row)
			public string CreateDeleteSQL(DataJuggler.NET8.DataRow Row)
			{
			...
			#region CreateInsertSQL(DataJuggler.NET8.DataRow row) +1 override
			
				#region CreateInsertSQL(DataJuggler.NET8.DataRow row)
				public string CreateInsertSQL(DataJuggler.NET8.DataRow Row)
				{
				...
				#region CreateInsertSQL(DataJuggler.NET8.DataRow row, bool WithOrWithoutChanges)
				public string CreateInsertSQL(DataJuggler.NET8.DataRow Row, bool WithOrWithoutChanges)
				{
			...
			#region CreateSelectAllSQL(DataJuggler.NET8.DataTable table) 
			/// <summary>
			...
			public string CreateSelectAllSQL(DataJuggler.NET8.DataTable dataTable)
			{		
			...
			#region CreateSelectSQL(DataJuggler.NET8.DataTable table, int primaryKeyValue) +3 overrides
			
				#region CreateSelectSQL(DataJuggler.NET8.DataTable table, int primaryKeyValue) 
				/// <summary>
				...
				/// </summary>
				/// <param name="table">DataJuggler.NET8.DataTable</param>
				...
				public string CreateSelectSQL(DataJuggler.NET8.DataTable table, int primaryKeyValue)
				{
				...
				#region CreateSelectSQL(DataJuggler.NET8.DataTable table, double primaryKeyValue) 
				/// <summary>
				/// Returns a valid sql statement to load an object from a table based upon the primary key.
				/// This is for a single field primary key.
				/// </summary>
				...
				/// <returns>A valid sql statement if the table has a primary key</returns>
				public string CreateSelectSQL(DataJuggler.NET8.DataTable table, double primaryKeyValue)
				{
					// Verify table Has A Primary Key
					if(table.PrimaryKey != null)
					{
				...
				#region CreateSelectSQL(DataJuggler.NET8.DataTable table, string primaryKeyValue) 
				/// <summary>
				/// Returns a valid sql statement to load an object from a table based upon the primary key.
				/// This is for a single field primary key.
				/// </summary>
				...
				/// <returns>A valid sql statement if the table has a primary key</returns>
				public string CreateSelectSQL(DataJuggler.NET8.DataTable table, string primaryKeyValue)
				{
					// Verify table Has A Primary Key
					if(table.PrimaryKey != null)
					{
				...
				#region CreateSelectSQL(DataJuggler.NET8.DataTable table, string fieldName, string fieldValue) 
				/// <summary>
				...
				public string CreateSelectSQL(DataJuggler.NET8.DataTable table, string fieldName, string fieldValue)
				{
					// bool UseQuotes
			...
			#region CreateUpdateSQL(DataJuggler.NET8.DataRow row)
			public string CreateUpdateSQL(DataJuggler.NET8.DataRow Row)
			{
				// Boolean For Is This The First field
				bool FirstField = true;
			...
			public bool IsString(DataJuggler.NET8.DataTable table, string fieldName)
			{
                // initial value
                bool isString = false;
                
				// Create Generic row
				DataJuggler.NET8.DataRow row = new DataRow();
			...
			#region IsUpdateable(DataJuggler.NET8.DataRow row)
			public bool IsUpdateable(DataJuggler.NET8.DataRow Row)
			{
                // Initial Value
                bool updateable = false;

				// Check If There Is A PrimaryKey
				DataJuggler.NET8.DataField PrimaryKey = Row.PrimaryKey();
