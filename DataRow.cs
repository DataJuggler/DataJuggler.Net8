...
namespace DataJuggler.NET8
{
	...
	public class DataRow
	{
		...
		private int index;
		private DataJuggler.NET8.DataTable parentTable;
		private string tag;
		#endregion
		...
		#region Constructor
			...
			#region DataRow(DataJuggler.NET8.DataTable ParentDataTable)
			public DataRow(DataJuggler.NET8.DataTable ParentDataTable)
			{
				// Set Parent table
		...
		#region Methods
			...
			#region PrimaryKey()
			public DataJuggler.NET8.DataField PrimaryKey()
			{
				// Create DataField 
				DataJuggler.NET8.DataField NoField = new DataField();
				NoField.FieldName = "void";

				// Search For PrimaryKey
				foreach(DataJuggler.NET8.DataField Field in this.Fields)
				{
		...
		#region Properties
			...
			#region ParentTable
			public DataJuggler.NET8.DataTable ParentTable
			{
				get
				{
					return parentTable;
