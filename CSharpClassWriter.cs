...
namespace DataJuggler.NET8
{
	...
	{  
        ...
        private const string DelegatesReference = "DataJuggler.NET8.Delegates";
        private const string EnumerationsReference = "DataJuggler.NET8.Enumerations";
        #endregion
		...
		#region Methods
            ...
            #region CloneField(DataJuggler.NET8.DataField field,string newObjectName)
            public string CloneField(DataJuggler.NET8.DataField field,string newObjectName)
			{
                // local
                    ...
                    else
                    {
                        ...
                        switch (field.DataType)
				        {
					        ...
					        case DataManager.DataTypeEnum.DataTable:
						        ...
						        dataType =  "DataJuggler.NET8.DataTable";
			...
			#region CreateForEach(DataJuggler.NET8.DataTable table)
			/// <summary>
			/// This method creates a foreach for each field in the table
			/// </summary>
			/// <param name="table"></param>
			/// <returns></returns>
			public string CreateForEach(DataJuggler.NET8.DataTable table)
			{
            ...
            #region GetCompareLine(DataJuggler.NET8.DataTable table, string primaryKeyName)
            /// <summary>
            ...
            /// <returns></returns>
            public string GetCompareLine(DataJuggler.NET8.DataTable table, string primaryKeyName)
			{
			...
			public void InitializeStrings(List<DataField> fields)
			{
				...
				foreach(DataJuggler.NET8.DataField field in fields)
				{
			...
			#region LoadField(DataJuggler.NET8.DataField field)
			public string LoadField(DataJuggler.NET8.DataField Field)
			{
				// String Builder  
				StringBuilder sb = new StringBuilder("this.");
			...
			#region NullField(DataJuggler.NET8.DataField field)
			public string NullField(DataJuggler.NET8.DataField Field)
			{
				// Create StringBuilder
            ...
            #region ParseFieldValue(DataJuggler.NET8.DataField field)
            /// <summary>
            /// Parse the field value
            /// </summary>
            /// <param name="field"></param>
            /// <returns></returns>
            public string ParseFieldValue(DataJuggler.NET8.DataField field)
			{
				// Create StringBuilder Object
				StringBuilder sb = new StringBuilder();
			...
			#region SaveObject(DataJuggler.NET8.DataTable table)
			/// <summary>
			...
			/// <param name="table"></param>
			/// <returns></returns>
			public string SaveObject(DataJuggler.NET8.DataTable table)
			{
				// Create New Object Name
			...
			#region UpdateLine(DataJuggler.NET8.DataField field)
			public string UpdateLine(DataJuggler.NET8.DataField Field)
			{
			...
			private void WriteAddMethod(DataJuggler.NET8.DataTable table)
			{
			...
			{	
				// Write Each Class
				foreach(DataJuggler.NET8.DataTable table in tables)
				{
			...
			private void WriteConstructor(DataJuggler.NET8.DataTable table)
			{
			...
			#region WriteCreateTableMethod(DataJuggler.NET8.DataTable table)
			private void WriteCreateTableMethod(DataJuggler.NET8.DataTable table)
			{
				...
				// Write BeginRegion "CreateTable(DataJuggler.NET8.DataTable table)";
				line = "CreateTable(DataJuggler.NET8.DataTable table)";
				BeginRegion(line);

				// Write Method Name
				line = "private void CreateTable(DataJuggler.NET8.DataTable table)";
				WriteLine(line);
				...
				// Instanciate table
				line = "this.table = new DataJuggler.NET8.DataTable();";
				WriteLine(line);

				// Create field For Adding To Fields Collection
				line = "DataJuggler.NET8.DataField field = new DataJuggler.NET8.DataField();";
				WriteLine(line);
				...
				foreach(DataJuggler.NET8.DataField Field in table.ActiveFields)
				{
					// Write Blank Line
					WriteLine();
					...
					line = "field = new DataJuggler.NET8.DataField();";
					WriteLine(line);
			...
			#region WriteDataClassVariables(DataJuggler.NET8.DataTable table)
			private void WriteDataClassVariables(DataJuggler.NET8.DataTable table)
			{
				// local StringBuilder
				StringBuilder sb = new StringBuilder();
			...
			#region WriteDeleteChanges(DataJuggler.NET8.DataTable table)
			private void WriteDeleteChanges(DataJuggler.NET8.DataTable table)
			{
			...
			private void WriteExportToDataRowMethod(DataJuggler.NET8.DataTable dataTable)
			{
				...
				// Create row
				DataJuggler.NET8.DataRow dataRow = new DataRow(dataTable);
			...
			#region WriteGetIndex(DataJuggler.NET8.DataTable table)
			private void WriteGetIndex(DataJuggler.NET8.DataTable table)
			{
			...
			#region WriteInitialChanges(DataJuggler.NET8.DataTable table)
			private void WriteInitialChanges(DataJuggler.NET8.DataTable table)
			{
			...
			#region WriteLoadMethodFromDataRow(DataJuggler.NET8.DataTable table)
			private void WriteLoadMethodFromDataRow(DataJuggler.NET8.DataTable table)
			{
				// Local Variable
				string line = "";
			...
			#region WriteLoadMethods(DataJuggler.NET8.DataTable table)
			private void WriteLoadMethods(DataJuggler.NET8.DataTable table)
			{	
			...
			#region WriteMethods()
			private void WriteMethods(DataJuggler.NET8.DataTable table)
			{
				// Begin Region Constructor
				BeginRegion("Methods");
			...
			#region WriteProperties(DataJuggler.NET8.DataTable table) void
			private void WriteProperties(DataJuggler.NET8.DataTable table)
			{
			...
			public void WriteReferences(ReferencesSet references, bool requireDelegatesReference = false)
			{
                ...
                try
                {
                    ...
                    {  
                        ...
                        // if this reference name equals DataJuggler.NET8.Delegates
                        ...
                        // if this reference name equals DataJuggler.NET8.Enumerations
                    ...
                    if ((requireDelegatesReference) && (!hasDelegateReference))
                    {
                        ...
                        // write out the reference for DataJuggler.NET8.Delegates
                    ...
                    if ((requireDelegatesReference) && (!hasEnumerationsReference))
                    {
                        ...
                        // write out the reference for DataJuggler.NET8.Enumerations
                        WriteReference(referenceObject);
                    }
